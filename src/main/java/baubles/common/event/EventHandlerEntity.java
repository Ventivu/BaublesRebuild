...
import static baubles.common.Configuration.Configuration.isSplitSurvivalCreative;
...
public class EventHandlerEntity {
    ...
    private void playerLoadDo(EntityPlayer player, File directory, Boolean gamemode) {
        ...
        if (gamemode || !isSplitSurvivalCreative()) {
            fileName = "baub";
    ...
    private void playerSaveDo(EntityPlayer player, File directory, Boolean gamemode) {
        if (gamemode || !isSplitSurvivalCreative()) {
            PlayerHandler.savePlayerBaubles(player, getPlayerFile("baub", directory, player.getCommandSenderName()), getPlayerFile("baubback", directory, player.getCommandSenderName()));
        } else {
            PlayerHandler.savePlayerBaubles(player, getPlayerFile("baubs", directory, player.getCommandSenderName()), getPlayerFile("baubsback", directory, player.getCommandSenderName()));
        }
    }
